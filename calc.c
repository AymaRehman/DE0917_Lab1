...
// -d or --dir and then source dirctory name, these are mandatory
...
// Only a few minor programming details including syntax were occassionally referred to at a basic level; 
